  ...
  try {
    const response = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        ...
        max_tokens: 1000,
        system: `You are a particle shape generator. Given a description, return ONLY a JSON array of [x,y] coordinate pairs forming the outline and silhouette of that shape.
Rules:
